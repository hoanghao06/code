...
data_SS= pd.read_csv(r'C:\Users\dinhk\Desktop\UAV_FSO_RF_DRL-main\output HS 15\speed_15\0\episode_rewards.csv') # reward chuyển mạch mềm
...
episodes = data_SS['Episode Number']
rewards_SS = data_SS['Episode Reward']
# rewards_HS = data_HS['Episode Reward']
# Làm mượt với cửa sổ trượt 
window_size = 10
rewards_SS = moving_average(rewards_SS, window_size)
# rewards_HS = moving_average(rewards_HS, window_size)
